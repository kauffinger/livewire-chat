...
<ui-disclosure {{ $attributes->class('group/disclosure') }} @if ($expanded === true) open @endif
    ...
    <div class="hidden relative space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute w-px inset-y-[3px] start-0 ms-4 bg-zinc-200 dark:bg-white/30"></div>
